import { default as color_ } from "./Color";
import { default as simplify_ } from "./Simplify";

export const Color = color_;
export const Simplify = simplify_;
...
export const getCoverSize = (contentWidth, contentHeight, containerWidth, containerHeight, offsetLeft, offsetTop)=>{
...
export const Base64 = {_keyStr:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",encode:function
